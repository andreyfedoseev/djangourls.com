...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TrendItem.title'
        db.alter_column('trends_trenditem', 'title', self.gf('django.db.models.fields.CharField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'TrendItem.title'
        db.alter_column('trends_trenditem', 'title', self.gf('django.db.models.fields.CharField')(max_length=400))
