...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'WhitelistWord'
        db.create_table('trends_whitelistword', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('word', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('trends', ['WhitelistWord'])


    def backwards(self, orm):
        # Deleting model 'WhitelistWord'
        db.delete_table('trends_whitelistword')
    ...
    models = {
        ...
        'trends.whitelistword': {
            'Meta': {'object_name': 'WhitelistWord'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'word': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        }
    }
